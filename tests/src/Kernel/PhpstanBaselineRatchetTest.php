...
class PhpstanBaselineRatchetTest extends TestCase
{
    ...
    private const CEILING = [
        ...
        'missingType.return' => 921,
        'missingType.parameter' => 761,
        'missingType.iterableValue' => 604,
        'missingType.property' => 481,
        'missingType.generics' => 7,

        // ---- claims that the code is wrong: burn these first (ticket 40) ----
        'argument.type' => 205,
        'offsetAccess.notFound' => 49,
        'variable.undefined' => 35,
        'function.alreadyNarrowedType' => 32,
        'phpDoc.parseError' => 25,
        'return.type' => 23,
        'deadCode.unreachable' => 18,
        'offsetAccess.nonOffsetAccessible' => 16,
        'empty.variable' => 13,
        ...
        'return.unusedType' => 5,
        'empty.offset' => 4,
        'encapsedStringPart.nonString' => 4,
        'function.impossibleType' => 4,
        'isset.variable' => 4,
        'return.missing' => 4,
        'return.phpDocType' => 4,
