...
class PhpstanBaselineRatchetTest extends TestCase
{
    ...
    private const CEILING = [
        'missingType.return' => 379,
        'missingType.property' => 165,
        'missingType.iterableValue' => 148,
        'missingType.parameter' => 139,
        'missingType.generics' => 3,

        'argument.type' => 94,
        'function.alreadyNarrowedType' => 12,
        'method.nonObject' => 9,
        'offsetAccess.notFound' => 9,
        'empty.variable' => 8,
        'offsetAccess.nonOffsetAccessible' => 7,
        'method.alreadyNarrowedType' => 6,
        'property.notFound' => 6,
        'nullCoalesce.expr' => 5,
        'nullCoalesce.offset' => 4,
        'foreach.nonIterable' => 3,
        'if.alwaysFalse' => 3,
        'isset.variable' => 3,
        'method.unused' => 3,
        'nullCoalesce.variable' => 3,
        'binaryOp.invalid' => 2,
        'booleanAnd.leftAlwaysTrue' => 2,
        'booleanNot.alwaysFalse' => 2,
        'equal.alwaysFalse' => 2,
