...
class SsrfUrlValidatorTest extends TestCase
{
    ...
    public function testOnlyTheSchemesTheCallerAsksForAreAccepted(string $url, array $schemes, bool $accepted): void
    {
        if (!$accepted) {
            $this->expectException(\Exception::class);
        }
    ...
    public function testACallerThatNamesNoSchemeGetsHttpsOnly(): void
    {
        $this->expectException(\Exception::class);
    ...
    public function testTheRequestIsTiedToTheAddressThatWasChecked(): void
    {
    ...
    public function testNothingIsPinnedForAnAddressThatWasRefused(): void
    {
        $this->expectException(\Exception::class);
