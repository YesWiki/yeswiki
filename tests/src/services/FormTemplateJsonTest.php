...
/**
 * Ticket 26: form templates are stored as JSON arrays of named-attribute field objects ("the prepared json"); the historical positional `***` syntax is only ever READ (old revisions, imports from older wikis) and re-encoded to JSON on every write.
 */
