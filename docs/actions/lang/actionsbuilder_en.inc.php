...
return [
    ...
    'AB_attach_caption_label' => 'Caption text',
    ...
    'AB_advanced_action_login_template_label' => 'Template',
    'AB_buttons_action_button_title_label' => 'Caption text',
    ...
    'AB_bazarcarto_barregestion_label' => 'Sheet management bar',
    'AB_bazarlisteliens_label' => 'List of links',
    'AB_bazarblog_description' => 'The sheets will be in the form of a blog.',
    'AB_bazarblog_header_label' => "Show the header",
    'AB_bazarannuaire_label' => 'Directory',
    'AB_bazarannuaire_description' => "Displays the sheets as an alphabetical directory",
    ...
    'AB_attach_class_izmir_revealup' => 'High text',
    'AB_advanced_action_listusers_last_label' => 'List only the last accounts created',
    'AB_advanced_action_textsearch_phrase_label' => 'to be searched',
    ...
    'AB_advanced_action_interwikilist_label' => 'Show list interwiki',
    ...
    'AB_syndication_action_template_list_and_description' => 'Flux as a list with description',
    'AB_syndication_action_formatdate_option_jma' => 'Day Month Year',
    'AB_advanced_action_backlinks_page_label' => 'Basic page',
    'AB_advanced_action_listusers_last_hint' => 'Number of accounts to be shown',
