...
if (!class_exists('\YesWiki\WikiniFormatter')) {
    class WikiniFormatter
    {
        ...
        public function openTag($tag, $attr = array())
        {
            $res = '<' . $tag;
         ...
         */
        public function inLineTag($tag, $class = null, $attr = array())
        {
            if ($class !== null) {
                $attr['class'] = $class;
            }
