...
('AnnuaireAlpha',  datetime('now'), '{{nav links="TrombiAnnuaire, AnnuaireAlpha, CartoAnnuaire, SaisirAnnuaire" titles="Trombinoscope, Annuaire alphabétique, Annuaire cartographique, S''inscrire dans l''annuaire"}}

{{bazarliste id="1" template="annuaire_alphabetique"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('BacASable',  datetime('now'), '# Bac à sable
...
('BazaR',  datetime('now'), '{{bazar showexportbuttons="1"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('CartoAnnuaire',  datetime('now'), '{{nav links="TrombiAnnuaire, AnnuaireAlpha, CartoAnnuaire, SaisirAnnuaire" titles="Trombinoscope, Annuaire alphabétique, Annuaire cartographique, S''inscrire dans l''annuaire"}}

{{bazarliste id="1" template="map" markersize="small" height="800px" zoom="6"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('DerniersChangementsRSS',  datetime('now'), '{{recentchangesrss}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('ExempleFormulaire',  datetime('now'), '# Exemples de formulaires à adapter (ou à jeter)
...
('FacetteRessource',  datetime('now'), '{{nav links="FacetteRessource, SaisirRessource" titles="Les ressources, Déposer une ressource"}}

{{bazarliste id="4" template="liste_accordeon" correspondance="soustitre=bf_description" groups="bf_type" titles="Tri par type" voirmenu="0" vue="recherche" }}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('GererConfig',  datetime('now'), '{{nav links="GererSite, GererDroits, GererThemes, GererUtilisateurs, GererConfig, GererMisesAJour, GererSauvegardes" titles="Gestion du site, Droits, Look, Utilisateurices, Fichier de conf, MAJ / extensions, Sauvegardes"}}

{{editconfig}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('GererDroits',  datetime('now'), '{{nav links="GererSite, GererDroits, GererThemes, GererUtilisateurs, GererConfig, GererMisesAJour, GererSauvegardes" titles="Gestion du site, Droits, Look, Utilisateurices, Fichier de conf, MAJ / extensions, Sauvegardes"}}
...
('GererDroitsActions',  datetime('now'), '//Droits d''accès//
...
('GererDroitsHandlers',  datetime('now'), '//Droits d''accès//
{{nav class="nav nav-tabs" hideifnoaccess="true" links="GererDroitsActions, GererDroitsHandlers, GererDroits" titles="Actions, Handlers, Pages" }}

#### Droits d''accès aux handlers

{{edithandlersacls}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('GererMisesAJour',  datetime('now'), '{{nav links="GererSite, GererDroits, GererThemes, GererUtilisateurs, GererConfig, GererMisesAJour, GererSauvegardes" titles="Gestion du site, Droits, Look, Utilisateurices, Fichier de conf, MAJ / extensions, Sauvegardes"}}

#### Mises à jour / extensions
{{update}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('GererSauvegardes',  datetime('now'), '{{nav links="GererSite, GererDroits, GererThemes, GererUtilisateurs, GererConfig, GererMisesAJour, GererSauvegardes" titles="Gestion du site, Droits, Look, Utilisateurices, Fichier de conf, MAJ / extensions, Sauvegardes"}}

{{adminbackups}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('GererSite',  datetime('now'), '{{nav links="GererSite, GererDroits, GererThemes, GererUtilisateurs, GererConfig, GererMisesAJour, GererSauvegardes" titles="Gestion du site, Droits, Look, Utilisateurices, Fichier de conf, MAJ / extensions, Sauvegardes"}}
...
('GererThemes',  datetime('now'), '{{nav links="GererSite, GererDroits, GererThemes, GererUtilisateurs, GererConfig, GererMisesAJour, GererSauvegardes" titles="Gestion du site, Droits, Look, Utilisateurices, Fichier de conf, MAJ / extensions, Sauvegardes"}}
...
('GererUtilisateurs',  datetime('now'), '{{nav links="GererSite, GererDroits, GererThemes, GererUtilisateurs, GererConfig, GererMisesAJour, GererSauvegardes" titles="Gestion du site, Droits, Look, Utilisateurices, Fichier de conf, MAJ / extensions, Sauvegardes"}}
...
('LookWiki',  datetime('now'), '{{nav links="GererSite, GererDroits, GererThemes, GererUtilisateurs, GererConfig, GererMisesAJour, GererSauvegardes" titles="Gestion du site, Droits, Look, Utilisateurices, Fichier de conf, MAJ / extensions, Sauvegardes"}}
...
('MesContenus',  datetime('now'), '# Mes contenus
{{accordion }}
...
{{end elem="panel"}}
{{end elem="accordion"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('MotDePassePerdu',  datetime('now'), '{{lostpassword}}
', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('PageColonneDroite',  datetime('now'), 'Double cliquer sur ce texte pour éditer cette colonne.
...
/* } */', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('PageFooter',  datetime('now'), '{{section class="text-center"}}
{{yeswikiversion}}
{{end elem="section"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('PageHeader',  datetime('now'), '{# Si vous activez ce code, une page header (bandeau du haut) apparaitra dans TOUTES les pages de votre site :
...
('PageLogin',  datetime('now'), '{{login context="login-page" signupurl="0"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('PageMenu',  datetime('now'), ' - [Accueil]({{rootPage}})
...
""""', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('PageMenuHaut',  datetime('now'), ' - [Bac à sable](BacASable)
 - Menu exemple
...
#}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('{{rootPage}}',  datetime('now'), '{{section bgcolor="#eeeeee" class="cover full-width text-left" file=""}}
...
('PageRapideHaut',  datetime('now'), '{{moteurrecherche template="moteurrecherche_button.tpl.html"}}
...
('PageTitre',  datetime('now'), '{{configuration param="wakka_name" }}
...
('ParametresUtilisateur',  datetime('now'), '{{UserSettings}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('RechercheTexte',  datetime('now'), '{{newtextsearch}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('ReglesDeFormatage',  datetime('now'), 'N''hésitez pas à personnaliser cette page d''aide (code utile, astuce...) en cliquant sur [ReglesDeFormatage](ReglesDeFormatage/edit){.newtab}
...
('SaisirAgenda',  datetime('now'), '{{nav links="VueActivite, VueAgenda, SaisirAgenda" titles="Voir les prochaines activités, Voir l''agenda, Proposer une activité"}}

{{bazar voirmenu="0" vue="saisir" id="2"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('SaisirAnnuaire',  datetime('now'), '{{nav links="TrombiAnnuaire, AnnuaireAlpha, CartoAnnuaire, SaisirAnnuaire" titles="Trombinoscope, Annuaire alphabétique, Annuaire cartographique, S''inscrire dans l''annuaire"}}

{{bazar voirmenu="0" vue="saisir" id="1"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('SaisirBlog',  datetime('now'), '{{nav links="VoirBlog, VoirBlogSimple, SaisirBlog" titles="Le blog avec Une, Le blog sans Une, Déposer une actu"}}

{{bazar vue="saisir" voirmenu="0" id="3"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('SaisirRessource',  datetime('now'), '{{nav links="FacetteRessource, SaisirRessource" titles="Les ressources, Déposer une ressource"}}

{{bazar voirmenu="0" vue="saisir" id="4"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('TableauDeBord',  datetime('now'), '# Tableau de bord
{{accordion }}
...
{{end elem="panel"}}
{{end elem="accordion" }}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('TrombiAnnuaire',  datetime('now'), '{{nav links="TrombiAnnuaire, AnnuaireAlpha, CartoAnnuaire, SaisirAnnuaire" titles="Trombinoscope, Annuaire alphabétique, Annuaire cartographique, S''inscrire dans l''annuaire"}}
...
('VoirBlog',  datetime('now'), '{{nav links="VoirBlog, VoirBlogSimple, SaisirBlog" titles="Le blog avec Une, Le blog sans Une, Déposer une actu"}}

{{bazarliste id="3" template="blog"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('VoirBlogSimple',  datetime('now'), '{{nav links="VoirBlog, VoirBlogSimple, SaisirBlog" titles="Le blog avec Une, Le blog sans Une, Déposer une actu"}}

{{bazarliste id="3" template="blog" header="no"}}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('VueActivite',  datetime('now'), '{{nav links="VueActivite, VueAgenda, SaisirAgenda" titles="Voir les prochaines activités, Voir l''agenda, Proposer une activité"}}

{{bazarliste template="agenda" id="2" ordre="desc" champ="bf_date_debut_evenement" agenda="futur" }}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('VueAgenda',  datetime('now'), '{{nav links="VueActivite, VueAgenda, SaisirAgenda" titles="Voir les prochaines activités, Voir l''agenda, Proposer une activité"}}

{{bazarliste id="2" template="calendar" }}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('WikiAdmin',  datetime('now'), '{{redirect page="GererSite"}}
', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('YesWiki',  datetime('now'), 'YesWiki', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', '');
-- end YesWiki pages
...
-- Bazar lists
INSERT INTO "{{prefix}}pages" ("tag", "time", "body", "body_r", "owner", "user", "latest", "handler", "comment_on") VALUES
('ListeType',  datetime('now'), '{"label":{"1":"Site web ressource","2":"Exp\\u00e9rience inspirante","3":"Partenaire ressource","4":"M\\u00e9thodologie \\/ guide"},"titre_liste":"Type"}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', '');
...
-- Bazar entries
INSERT INTO "{{prefix}}pages" ("tag", "time", "body", "body_r", "owner", "user", "latest", "handler", "comment_on") VALUES
('Bordeaux',  datetime('now'), '{"bf_titre":"Super \\u00e9v\\u00e9nement \\u00e0 Bordeaux","bf_description":"Un \\u00e9v\\u00e9nement autour du vin, c''est pour cela qu''il est \\u00e0 Bordeaux...","bf_date_debut_evenement":"2024-04-10","bf_date_fin_evenement":"2024-04-12","bf_site_internet":"","bf_adresse":"","bf_code_postal":"","bf_ville":"Bordeaux","bf_latitude":"44.841225","bf_longitude":"-0.5800364","id_typeannonce":"2","id_fiche":"Bordeaux","fichierfichier":"","geolocation":{"bf_latitude":"44.841225","bf_longitude":"-0.5800364"},"date_creation_fiche":"2021-06-21 19:33:56","statut_fiche":"1","imagebf_image":"","date_maj_fiche":"2024-04-02 16:17:09"}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('YeswikiLeSiteOfficiel',  datetime('now'), '{"bf_titre":"Yeswiki : le site officiel","bf_url":"https:\\/\\/yeswiki.net","bf_description":"Tout ce qu''il y a \\u00e0 savoir sur Yeswiki ","bf_auteur":"","id_typeannonce":"4","id_fiche":"YeswikiLeSiteOfficiel","fichierfichier":"","date_creation_fiche":"2020-02-12 11:10:01","statut_fiche":"1","bf_type":"1","imagebf_image":null,"date_maj_fiche":"2021-09-07 12:10:10"}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('FramasofT',  datetime('now'), '{"bf_titre":"Framasoft","bf_url":"https:\\/\\/framasoft.org\\/fr\\/","bf_description":"Framasoft, c\\u2019est une association d\\u2019\\u00e9ducation populaire, un groupe d\\u2019ami\\u00b7es convaincu\\u00b7es qu\\u2019un monde num\\u00e9rique \\u00e9mancipateur est possible, persuad\\u00e9\\u00b7es qu\\u2019il adviendra gr\\u00e2ce \\u00e0 des actions concr\\u00e8tes sur le terrain et en ligne avec vous et pour vous !","bf_auteur":"","id_typeannonce":"4","id_fiche":"FramasofT","fichierfichier":"","date_creation_fiche":"2020-02-12 14:12:58","statut_fiche":"1","bf_type":"3","imagebf_image":null,"date_maj_fiche":"2021-09-07 12:07:38"}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('UnBeauLogoPourYeswiki',  datetime('now'), '{"bf_titre":"Un beau logo pour Yeswiki","bf_chapeau":"Il fallait le rafraichir, nous l''avons fait ! ","bf_description":"Apr\\u00e8s multiples discussions, tests et essais, un logo plus actuel a \\u00e9t\\u00e9 cr\\u00e9\\u00e9 pour Yeswiki\\r\\nNous esp\\u00e9rons que vous l''aimerez ;-) ","id_typeannonce":"3","id_fiche":"UnBeauLogoPourYeswiki","date_creation_fiche":"2020-02-12 13:16:06","statut_fiche":"1","imagebf_image":"UnBeauLogoPourYeswiki_yeswiki-logo.png","date_maj_fiche":"2021-09-05 13:23:52"}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('UnNouveauThemePourYeswiki',  datetime('now'), '{"bf_titre":"Un nouveau th\\u00e8me pour Yeswiki","bf_chapeau":"Margot, voil\\u00e0 le nom du nouveau th\\u00e8me qui sera distribu\\u00e9 avec la prochaine version de Yeswiki\\t","bf_description":"Plus moderne, mieux pens\\u00e9, plus graphiqu.\\r\\nMargot permettra d''unifier les rendus graphiques des wikis.","id_typeannonce":"3","id_fiche":"UnNouveauThemePourYeswiki","date_creation_fiche":"2020-02-12 12:17:49","statut_fiche":"1","imagebf_image":"UnNouveauThemePourYeswiki_capture-de\\u0301cran-2020-02-12-a\\u0300-13.16.33.png","date_maj_fiche":"2020-02-12 12:17:50"}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('ElizabethJFeinler',  datetime('now'), '{"bf_titre":"JFeinler Elizabeth","bf_nom":"JFeinler","bf_prenom":"Elizabeth","bf_fonction":"informaticienne, pionni\\u00e8re de l''internet","bf_projet":"En 1974, j''ai cr\\u00e9\\u00e9 le nouveau Network Information Center (NIC) de l''ARPANET.  ","bf_mail":"","bf_structure":"Stanford Research Institute et NASA ","bf_site_internet":"https:\\/\\/fr.wikipedia.org\\/wiki\\/Elizabeth_J._Feinler","bf_adresse":"","bf_code_postal":"","bf_ville":"Paris","bf_latitude":"48.8566969","bf_longitude":"2.3514616","id_typeannonce":"1","id_fiche":"ElizabethJFeinler","imagebf_image":"ElizabethJFeinler_elizabethfeinler-2011.jpg","geolocation":{"bf_latitude":"48.8566969","bf_longitude":"2.3514616"},"date_creation_fiche":"2021-05-24 22:07:17","statut_fiche":"1","date_maj_fiche":"2021-08-06 10:31:00"}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('TesT2',  datetime('now'), '{"bf_titre":"Sortie Culturelle","bf_description":"La culture, moins on en a, plus on l''\\u00e9tale!","bf_date_debut_evenement":"2024-05-30T18:00:00+02:00","bf_date_fin_evenement":"2024-05-30T20:00:00+02:00","bf_site_internet":"https:\\/\\/www.yeswiki.net","bf_adresse":"Avenue des Champs Elys\\u00e9es","bf_code_postal":"75000","bf_ville":"Paris","bf_latitude":"48.8659085","bf_longitude":"2.3197651","id_typeannonce":"2","id_fiche":"TesT2","imagebf_image":"TesT2_presence-photo.png","fichierfichier":"","geolocation":{"bf_latitude":"48.8659085","bf_longitude":"2.3197651"},"date_creation_fiche":"2024-04-02 16:25:51","statut_fiche":"1","date_maj_fiche":"2024-04-02 16:48:20"}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', ''),
('LovelaceAda',  datetime('now'), '{"bf_titre":"Lovelace Ada","bf_nom":"Lovelace","bf_prenom":"Ada","bf_fonction":"Pionni\\u00e8re de la science informatique ","bf_projet":"<p>J''ai r\\u00e9alis\\u00e9 le premier v\\u00e9ritable programme informatique, lors de mon travail sur un anc\\u00eatre de l''ordinateur : la machine analytique de Charles Babbage. <br><\\/p>","bf_mail":"","bf_structure":"Universit\\u00e9 de Cambridge ","bf_site_internet":"https:\\/\\/fr.wikipedia.org\\/wiki\\/Ada_Lovelace","bf_adresse":"","bf_code_postal":"","bf_ville":"Londres ","bf_latitude":"51.5073219","bf_longitude":"-0.1276474","id_typeannonce":"1","id_fiche":"LovelaceAda","geolocation":{"bf_latitude":"51.5073219","bf_longitude":"-0.1276474"},"date_creation_fiche":"2021-05-25 11:00:19","statut_fiche":"1","imagebf_image":"LovelaceAda_lovelace.png","date_maj_fiche":"2021-05-25 11:01:13"}', '', '{{WikiName}}', '{{WikiName}}', 'Y', 'page', '');
-- end Bazar entries
