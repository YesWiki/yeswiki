              ...
              (this.element = r.buildDom([
                ...
                [
                  ...
                  [
                    ...
                    f('search-box.find-all.text', 'All'),
                  ],
                ],
                [
                  'div',
          ...
          return (
            ...
            (e.prototype.updateCounter = function () {
              ...
              if (t) {
                var o = this.searchRange
                  ...
                  : e.getValue()
                e.$search.$isMultilineSearch(e.getLastSearchOptions()) &&
                  ((o = o.replace(/\r\n|\r|\n/g, '\n')),
                  (e.session.doc.$autoNewLine = '\n'))
                var u = e.session.doc.positionToIndex(e.selection.anchor)
                this.searchRange &&
                  (u -= e.session.doc.positionToIndex(this.searchRange.start))
                var a = (t.lastIndex = 0),
                  c
                while ((c = t.exec(o))) {
                  ;(r++, (a = c.index), a <= u && s++)
                  if (r > l) break
                  if (!c[0]) {
                    t.lastIndex = a += i.skipEmptyMatch(o, a, n)
                    if (a >= o.length) break
                  }
                }
              }
            ...
            (e.prototype.show = function (e, t) {
              ;((this.active = !0),
                ...
                this.editor.$search.$options.regExp && (e = i.escapeRegExp(e)),
