  ...
  aceContainer.addEventListener('keydown', (e) => {
    ...
    if (isCtrl === true && isAlt === false) {
      ...
      if (keyCode === 49 && isShift === true) {
        click('.aceditor-btn-title1'); e.preventDefault()
      } else if (keyCode === 50 && isShift === true) {
        // title 2
        click('.aceditor-btn-title2'); e.preventDefault()
      } else if (keyCode === 51 && isShift === true) {
        // title 3
        click('.aceditor-btn-title3'); e.preventDefault()
      } else if (keyCode === 52 && isShift === true) {
        // title 4
        click('.aceditor-btn-title4'); e.preventDefault()
      } else if (keyCode === 53 && isShift === true) {
        // title 5
        click('.aceditor-btn-title5'); e.preventDefault()
      } else if (keyCode === 66 && isShift === false) {
        // bold
        click('.aceditor-btn-bold'); e.preventDefault()
      } else if (keyCode === 73 && isShift === false) {
        // italic
        click('.aceditor-btn-italic'); e.preventDefault()
      } else if (keyCode === 85 && isShift === false) {
        // underline
        click('.aceditor-btn-underline'); e.preventDefault()
      } else if (keyCode === 89) {
        // strike
        click('.aceditor-btn-strike'); e.preventDefault()
      } else if (keyCode === 83 && isShift === false) {
        // save page
        click('.aceditor-btn-save'); e.preventDefault()
      } else if (keyCode === 58 && isShift === false) {
        // comment key ':'
        click('.aceditor-btn-comment'); e.preventDefault()
      }
