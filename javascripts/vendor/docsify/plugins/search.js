// This file has been modified in order to work better with yeswiki
// ================================================================

// the selector to get the list of pages to look into was targetting only links in the sidebar
// but in yeswiki we put the mains links in the nav, so I did change folllowing code
// Docsify.dom.findAll(".sidebar-nav a:not(.section-link):not([data-nosearch])
// to
// Docsify.dom.findAll(".sidebar-nav a:not(.section-link):not([data-nosearch]), nav a:not(.section-link):not([data-nosearch]))

// I have addeed this condition to not process external pages
...
(function () {
  ...
  function getAllPaths(router) {
    var paths = [];
    // Yeswiki fix, change selector to auto looks pages listed into `nav` section
    Docsify.dom
      .findAll(`.sidebar-nav a:not(.section-link):not([data-nosearch]),
                nav a:not(.section-link):not([data-nosearch])`)
