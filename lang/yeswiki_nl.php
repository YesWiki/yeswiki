...
return [
    ...
    // 'EDIT_CONFIG_HINT_DEFAULT_COMMENT_ACL' => 'Droits de lcommentaires par défaut des pages (comment-closed pour fermer, + pour personnes identifiées, @admins pour groupe admin)',
