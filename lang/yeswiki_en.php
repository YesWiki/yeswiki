...
'EDIT_CONFIG_HINT_meta_keywords' => 'keywords for search engine optimization (SEO) (coma separated, not more 20-30)',
'EDIT_CONFIG_HINT_meta_description' => 'Description of website in one sentence, for search engine optimization (SEO) (Warning : do not use "." (dot))',
'EDIT_CONFIG_HINT_meta' => 'Definition of meta tags',
...
'EDIT_CONFIG_HINT_use_alerte' => 'Display a popup message after editing a page before quiting without saving',
'EDIT_CONFIG_HINT_baz_map_center_lat' => 'Choose default center\'s latitude of wiki\'s maps',
'EDIT_CONFIG_HINT_baz_map_center_lon' => 'Choose default center\'s latitude of wiki\'s maps',
'EDIT_CONFIG_HINT_baz_map_zoom' => 'Choose default zoom level of wiki\'s maps',
'EDIT_CONFIG_HINT_baz_map_height' => 'Choose default height of wiki\'s maps',
...
'EDIT_CONFIG_HINT_BAZ_ADRESSE_MAIL_ADMIN' => 'Administrator\'se-mail address used as sender for particular messages from entries',
'EDIT_CONFIG_HINT_BAZ_ENVOI_MAIL_ADMIN' => 'Send an e-mail to admininistrators at each change in an entry (1)',
'EDIT_CONFIG_HINT_mail_custom_message' => 'Custom message for e-mail sending',
'EDIT_CONFIG_HINT_bazarIgnoreAcls' => 'Bypass access control list (ACL) when creating entries from forms (1 ou 0)',
