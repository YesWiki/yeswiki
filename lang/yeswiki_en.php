...
return [
    ...
    'ADMIN_BACKUPS_REMOTE_TITLE' => 'Fetch a backup from another wiki',
    'ADMIN_BACKUPS_REMOTE_HELP' => 'Asks another YesWiki for a full backup, brings it here, then deletes it there. Keep this page open while it transfers.',
    'ADMIN_BACKUPS_REMOTE_URL' => 'Address of the remote wiki',
    'ADMIN_BACKUPS_REMOTE_USERNAME' => 'Remote administrator name',
    'ADMIN_BACKUPS_REMOTE_PASSWORD' => 'Password',
    'ADMIN_BACKUPS_REMOTE_START' => 'Fetch',
    'ADMIN_BACKUPS_REMOTE_CANCEL' => 'Give up',
    ...
    'BASE_URL' => 'Base URL',
    'RESTORATION_OF_YESWIKI' => 'Restoration of YesWiki',
    'INSTALL_MODE_RESTORE' => 'Restore a backup found on this server',
    'INSTALL_MODE_NEW' => 'Install a new YesWiki',
    'INSTALL_RESTORE_FROM_BACKUP' => 'Restoration from a backup',
    'INSTALL_RESTORE_BACKUP_FILE' => 'Backup file',
    'INSTALL_RESTORE_TYPE_FULL' => 'database and files',
    'INSTALL_RESTORE_TYPE_ONLY_DB' => 'database only',
    'INSTALL_RESTORE_TYPE_ONLY_FILES' => 'files only',
    'INSTALL_RESTORE_FILES' => 'Restore the files of the backup (themes, custom, uploaded files)',
    'INSTALL_RESTORE_REWRITE_URLS_TO_BASE_URL' => 'Rewrite the links stored in the backup to the base URL above',
    'INSTALL_RESTORE_DROP_EXISTING' => 'Delete the tables already using this prefix',
    'INSTALL_RESTORE_DROP_EXISTING_INFOS' => 'Without this, the restoration stops when the prefix is already in use, so that another wiki sharing the database is left alone',
    'INSTALL_RESTORE_ZIP_NOT_FOUND' => 'Backup file not found',
    'INSTALL_RESTORE_ZIP_CANNOT_OPEN' => 'Backup file cannot be opened',
    'INSTALL_RESTORE_SQL' => 'Looking for the SQL dump',
    'INSTALL_RESTORE_SQL_NOT_FOUND' => 'SQL dump not found in the backup',
    'INSTALL_RESTORE_DB' => 'Restoration of the database',
    'INSTALL_RESTORE_DB_AND_FILES' => 'Restoration of the files',
    'INSTALL_RESTORE_ERROR' => 'Restoration failed',
    'INSTALL_RESTORE_REWRITE_URLS' => 'Rewriting the links stored in the backup:',
    'INSTALL_RESTORE_REWRITE_TABLE_PREFIX' => 'Renaming the tables of the backup:',
    'INSTALL_RESTORE_TABLE_PREFIX' => 'Checking the table prefix',
    'INSTALL_RESTORE_TABLE_PREFIX_UNKNOWN' => 'Cannot tell which table prefix this backup was taken with: it names no YesWiki table',
    'INSTALL_RESTORE_TABLE_PREFIX_INVALID' => 'A table prefix can only hold letters, digits and underscores',
    ...
    'PERFORM_MIGRATIONS' => 'Perfom migrations',
];
