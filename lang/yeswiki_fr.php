...
return [
    ...
    'EDIT_CONFIG_HINT_DEFAULT_COMMENT_ACL' => 'Droits de lcommentaires par défaut des pages (comment-closed pour ferme, * pour tous, + pour personnes identifiées, @admins pour groupe admin)',
