...
return [
    ...
    'ADMIN_BACKUPS_REMOTE_TITLE' => 'Récupérer une sauvegarde distante',
    'ADMIN_BACKUPS_REMOTE_HELP' => 'Demande à un autre YesWiki une sauvegarde complète, la rapatrie ici, puis l\'efface de là-bas. Gardez cette page ouverte pendant le transfert.',
    'ADMIN_BACKUPS_REMOTE_URL' => 'Adresse du wiki distant',
    'ADMIN_BACKUPS_REMOTE_USERNAME' => 'Nom de l\'administrateur distant',
    'ADMIN_BACKUPS_REMOTE_PASSWORD' => 'Mot de passe',
    'ADMIN_BACKUPS_REMOTE_START' => 'Récupérer',
    'ADMIN_BACKUPS_REMOTE_CANCEL' => 'Abandonner',
    ...
    'RESTORATION_OF_YESWIKI' => 'Restauration de YesWiki',
    'INSTALL_MODE_RESTORE' => 'Restaurer une sauvegarde présente sur ce serveur',
    'INSTALL_MODE_NEW' => 'Installer un nouveau YesWiki',
    'INSTALL_RESTORE_FROM_BACKUP' => 'Restauration depuis une sauvegarde',
    'INSTALL_RESTORE_BACKUP_FILE' => 'Fichier de sauvegarde',
    'INSTALL_RESTORE_TYPE_FULL' => 'base de données et fichiers',
    'INSTALL_RESTORE_TYPE_ONLY_DB' => 'base de données seule',
    'INSTALL_RESTORE_TYPE_ONLY_FILES' => 'fichiers seuls',
    'INSTALL_RESTORE_FILES' => 'Restaurer les fichiers de la sauvegarde (thèmes, custom, fichiers déposés)',
    'INSTALL_RESTORE_REWRITE_URLS_TO_BASE_URL' => 'Réécrire les liens enregistrés dans la sauvegarde vers l\'URL de base ci-dessus',
    'INSTALL_RESTORE_DROP_EXISTING' => 'Supprimer les tables qui utilisent déjà ce préfixe',
    'INSTALL_RESTORE_DROP_EXISTING_INFOS' => 'Sans cela, la restauration s\'arrête quand le préfixe est déjà utilisé, pour ne pas toucher à un autre wiki hébergé dans la même base',
    'INSTALL_RESTORE_ZIP_NOT_FOUND' => 'Fichier de sauvegarde introuvable',
    'INSTALL_RESTORE_ZIP_CANNOT_OPEN' => 'Impossible d\'ouvrir le fichier de sauvegarde',
    'INSTALL_RESTORE_SQL' => 'Recherche du fichier SQL',
    'INSTALL_RESTORE_SQL_NOT_FOUND' => 'Fichier SQL absent de la sauvegarde',
    'INSTALL_RESTORE_DB' => 'Restauration de la base de données',
    'INSTALL_RESTORE_DB_AND_FILES' => 'Restauration des fichiers',
    'INSTALL_RESTORE_ERROR' => 'La restauration a échoué',
    'INSTALL_RESTORE_REWRITE_URLS' => 'Réécriture des liens enregistrés dans la sauvegarde :',
    'INSTALL_RESTORE_REWRITE_TABLE_PREFIX' => 'Renommage des tables de la sauvegarde :',
    'INSTALL_RESTORE_TABLE_PREFIX' => 'Vérification du préfixe des tables',
    'INSTALL_RESTORE_TABLE_PREFIX_UNKNOWN' => 'Impossible de déterminer le préfixe des tables de cette sauvegarde : elle ne contient aucune table YesWiki',
    'INSTALL_RESTORE_TABLE_PREFIX_INVALID' => 'Un préfixe de table ne peut contenir que des lettres, des chiffres et des tirets bas',
    ...
    'EDIT_CONFIG_HINT_SUPPORTED_LANGS' => 'Langues supportées pour la traduction : (ex: [\'fr\',\'en\'])',
    ...
    'EDIT_CONFIG_GROUP_INTERNATIONALISATION' => 'Multilinguisme',
