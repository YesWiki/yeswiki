...
if (!empty($shownumberinfo) && $shownumberinfo == 1) {
	...
	if ($nb_total > 1) $info .= 'Un total de '.$nb_total.' pages ont &eacute;t&eacute; trouv&eacute;es';
	elseif ($nb_total == 1) $info .= 'Une page a &eacute;t&eacute; trouv&eacute;e';
	else $info .= 'Aucune page trouv&eacute;e';
