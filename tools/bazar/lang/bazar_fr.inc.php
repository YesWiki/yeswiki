...
$GLOBALS['translations'] = array_merge(
    ...
    array(
        ...
        'BAZ_NEED_WRITE_RIGHTS' => 'Vous n\'avez pas les droits d\'accès en écriture',
        ...
        'BAZ_FICHIER_IMAGE_INEXISTANT' => ' inexistant sur le serveur, la base de donn&eacute;es va être actualis&eacute;e. Veuillez actualiser votre navigateur.',
        ...
        'EDIT_CONFIG_HINT_BAZ_EXTERNAL_SERVICE_TIME_CACHE_TO_CHECK_CHANGES' => 'Temps (s) entre deux rafraîchissements du cache pour vérifier les ajouts et modifications dans les requêtes JSON',
        'EDIT_CONFIG_HINT_BAZ_EXTERNAL_SERVICE_TIME_CACHE_TO_CHECK_DELETION' => 'Temps (s) entre deux rafraîchissements du cache pour vérifier les suppresions dans les requêtes JSON',
