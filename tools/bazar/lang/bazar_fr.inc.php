...
$GLOBALS['translations'] = array_merge(
    ...
    array(
        ...
        'BAZ_IMPORT_DETECT_COLUMNS_ON_HEADERS' => 'Détecter les colonnes à partir des en-têtes (BETA)',
        'BAZ_IMPORT_DETECT_COLUMNS_ON_HEADER_HINT' => 'Permet de détecter les modifications dans les formulaires',
        'BAZ_NON' => 'Non',
        'BAZ_ANNULER' => 'Annuler',
        'BAZ_VALIDER' => 'Valider',
