...
return [
    ...
    'BAZ_UNREADABLE_MAP_VALUE' => 'Géolocalisation illisible, ignorée à l\'import',
    'BAZ_IMPORT_KEEP_REMOTE_FILES_AS_URL' => 'Conserver les images et fichiers distants sous forme d\'URL',
    'BAZ_IMPORT_KEEP_REMOTE_FILES_AS_URL_HINT' => 'Les colonnes image et fichier contenant une URL sont enregistrées telles quelles, sans télécharger les fichiers sur ce wiki.',
    'BAZ_NON' => 'Non',
    'BAZ_ANNULER' => 'Annuler',
    'BAZ_VALIDER' => 'Valider',
    ...
    'BAZ_ANNULER_IMAGE' => 'Annuler ce choix',
    ...
    'BAZ_DRAG_n_DROP_CHECKBOX_SELECTED_TEXT' => 'Sélectionnés : ',
    ...
    'BAZ_CHECKCONTENT_REMOTE_OPTIONS' => 'Champs lus depuis un autre serveur',
    'BAZ_CHECKCONTENT_REMOTE_OPTIONS_HINT' => 'Rien n\'a été vérifié dans ces champs : leurs valeurs vivent sur un autre wiki, et une panne réseau signalerait toutes les fiches comme cassées. Importez cette source en liste locale ou en fiches locales avec l\'extension importer, et la prochaine vérification les traitera comme n\'importe quel autre champ.',
    ...
    'BAZ_CHECKCONTENT_FIX_PERMISSIONS' => 'corriger les droits du fichier sur le serveur',
    ...
    'BAZ_CHECKCONTENT_UNREADABLE_FILE' => 'Fichier présent mais illisible',
    'BAZ_CHECKCONTENT_UNREADABLE_FILE_HINT' => 'Le fichier est bien sur le disque et le serveur web n\'arrive pas à le lire. La donnée est saine, les droits ne le sont pas : rien n\'est réparable depuis cette page.',
