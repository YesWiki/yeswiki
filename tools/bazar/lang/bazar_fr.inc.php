...
$GLOBALS['translations'] = array_merge(
    ...
    array(
        ...
        'BAZ_INTRO_AJOUT_LISTE' => '<strong>Pas de liste cr&eacute;&eacute;e pour l\'instant.</strong><br />Vous pouvez cr&eacute;er une nouvelle liste manuellement (cliquez sur le bouton avec un signe plus)<span class="hide">,<br />ou importer les listes d\'un YesWiki existant (comme http://yeswiki.net)</span>.',
