    ...
    public function run()
    {
        try {
            ...
            if ($id == null) {
                ...
                // $id a été transormé en tableau - cf PR précédente - on garde l'algorithme et on rajoute la possibilité
                // d'une spécification des ids séparés par des virgules (ex : id=1,2) ou des ids en tableau id[0]=1&id[0]=2
                // On extrait donc les élements du tableau séparés par de virgules afin d'avoir un tableau standardisé d'ids.
