...
$wakkaConfig['baz_provider_id'] = getConfigValue('baz_provider_id', '', $wakkaConfig);

// pwd du provider de carto
$wakkaConfig['baz_provider_pass'] = getConfigValue('baz_provider_pass', '', $wakkaConfig);

// icone du marqueur de base
$wakkaConfig['baz_marker_icon'] = getConfigValue('baz_marker_icon', 'bullseye', $wakkaConfig);
