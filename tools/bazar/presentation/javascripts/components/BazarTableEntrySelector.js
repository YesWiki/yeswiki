  ...
  computed: {
    entriesToDisplay() {
      return this.params !== null &&
        ...
        'tablewith' in this.params &&
        this.params.tablewith === 'no-geolocation'
        ? this.entries.filter(
            (e) =>
              typeof e === 'object' &&
              e !== null &&
              ((this.params.geolocationfield &&
                !(this.params.geolocationfield in e)) ||
                (this.params.geolocationfield &&
                  this.params.geolocationfield in e &&
                  !e[this.params.geolocationfield].latitude) ||
                (this.params.geolocationfield &&
                  this.params.geolocationfield in e &&
                  !e[this.params.geolocationfield].longitude) ||
                String(e[this.params.geolocationfield].latitude).length === 0 ||
                String(e[this.params.geolocationfield].longitude).length ===
                  0 ||
...
window._bazarDynamicComponents['BazarTableEntrySelector'] =
  BazarTableEntrySelector
