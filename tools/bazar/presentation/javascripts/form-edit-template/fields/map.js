...
export default {
  ...
  attributes: {
    autocomplete_street: {
      label: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_STREET'),
      value: '',
      placeholder: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_STREET_PLACEHOLDER'),
    },
    autocomplete_postalcode: {
      label: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_POSTALCODE'),
      value: '',
      placeholder: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_POSTALCODE_PLACEHOLDER'),
    },
    autocomplete_town: {
      label: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_TOWN'),
      value: '',
      placeholder: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_TOWN_PLACEHOLDER'),
    },
    autocomplete_county: {
      label: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_COUNTY'),
      value: '',
      placeholder: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_COUNTY_PLACEHOLDER'),
    },
    autocomplete_state: {
      label: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_STATE'),
      value: '',
      placeholder: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_STATE_PLACEHOLDER'),
    },
    autocomplete_other: { label: '', value: '' },
    autocomplete_street1: {
      label: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_STREET1'),
      value: '',
      placeholder: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_STREET1_PLACEHOLDER'),
    },
    autocomplete_street2: {
      label: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_STREET2'),
      value: '',
      placeholder: _t('BAZ_FORM_EDIT_MAP_AUTOCOMPLETE_STREET2_PLACEHOLDER'),
    },
    geolocate: {
    ...
    max_geometries: {
      label: _t('BAZ_FORM_EDIT_MAP_MAX_GEOMETRIES'),
      value: '',
    },
    read: readConf,
    write: writeconf,
    ...
    return {
      ...
      onRender() {
        ...
        $('.map-field.form-field')
          .find(
            'input[type=text][name=autocomplete_street]:not(.initialized)' +
            ...
            if (!$(element).hasClass('initialized')) {
              ...
              if (
                ...
                if (autoCompleteOther && autoCompleteOther.length > 0) {
                  ...
                  other.geolocate = ['1', 1, true].includes(value[0])
                    ? '1'
                    : '0'
              ...
              if (autoCompleteOther && autoCompleteOther.length > 0) {
                ...
                autoCompleteOther.val(
                  `${results.geolocate}|${results.street}` +
                    `|${results.street1}` +
                    `|${results.street2}` +
                    `|${results.county}` +
                    `|${results.state}`,
