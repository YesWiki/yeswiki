    ...
    return {
      ...
      onRender() {
        ...
        renderHelper.prependHTMLBeforeGroup(
          ...
          $('<div/>')
            .addClass('form-group')
            .append($('<b/>').append(_t('BAZ_FORM_EDIT_TABS_TITLES_LABEL'))),
        )
        renderHelper.defineLabelHintForGroup(
          field,
          'formTitles',
          _t('BAZ_FORM_EDIT_TABS_FORMTITLES_DESCRIPTION'),
        )
        renderHelper.defineLabelHintForGroup(
          field,
          'viewTitles',
          _t('BAZ_FORM_EDIT_TABS_VIEWTITLES_DESCRIPTION'),
        )
        renderHelper.prependHTMLBeforeGroup(
          field,
          'moveSubmitButtonToLastTab',
          $('<hr/>').addClass('form-group'),
        )
