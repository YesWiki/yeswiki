...
if (!empty($id_typeannonce)) {
    //récupération des paramètres pour la recherche bazar
    ...
    foreach ($tableau_resultat as $fiche) {
        ...
        if (count($tab)>1 && $tab[0]!='' && $tab[1]!='') {
            ...
            ';
            // on genere la liste des titres à cliquer pour faire apparaitre sur la carte
            $i++;
...
echo '<link rel="stylesheet" href="http://code.leafletjs.com/leaflet-0.3.1/leaflet.css" />
<!--[if lte IE 8]>
...
<script>
    ...
    var cloudmadeUrl = \'http://{s}.tile.cloudmade.com/BC9A493B41014CAABB98F0471D759707/997/256/{z}/{x}/{y}.png\',
        cloudmadeAttribution = \'Données OpenStreetMap\',
