...
if ($this->HasAccess('write') && $this->HasAccess('read')) {
    ...
    if (!isset($_POST['submit']) || (isset($_POST['submit']) && $_POST['submit'] != 'Sauver')) {
        ...
        $ChampsHashcash =
         '<script type="text/javascript" src="'.$siteurl.$slash.'tools/hashcash/wp-hashcash-js.php?siteurl='.urlencode($siteurl.$slash).'"></script><span id="hashcash-text" style="display:none" class="pull-right">'._t('HASHCASH_ANTISPAM_ACTIVATED').'</span>';
