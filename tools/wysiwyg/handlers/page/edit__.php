				...
				<script type="text/javascript">
					$().ready(function() {
						...
						$("textarea.tinymce").tinymce({
							...
							plugins : "save,pagebreak,style,layer,table,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,paste,directionality,noneditable,visualchars,nonbreaking,xhtmlxtras",
