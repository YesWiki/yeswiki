/*	This work is licensed under Creative Commons GNU LGPL License.
	...
	Adaptation Florian SCHMITT <florian@outils-reseaux.org>
	Original Author from wiky.js :  Stefan Goessner/2005-06
  ...
  rules: {
   ...
   inverse: {
     ...
     wikiinlines: [
       ...
       { rex:/<b[^>]*?>(.*?)<\/b>/mgi, tmplt:"**$1**" },
       { rex:/<em[^>]*?>(.*?)<\/em>/mgi, tmplt:"__$1__" },
       { rex:/<i[^>]*?>(.*?)<\/i>/mgi, tmplt:"__$1__" },
