...
return [
    ...
    'TEMPLATE_ERROR_NO_ACCESS' => 'ERREUR : pas les droits d\'accés.',
    ...
    'DIAPORAMA_PAGE_PARAM_MISSING' => 'Action diaporama : paramêtre "page" obligatoire.',
    'DIAPORAMA_TEMPLATE_PARAM_ERROR' => 'Action diaporama : le paramêtre "template" pointe sur un fichier inexistant ou illisible. Le template par défaut sera utilisé.',
...
{{end elem=\"tab\"}}",
    ...
    'PROGRESSBAR_ERROR_VAL_PARAM' => 'le paramètre "val" doit étre un chiffre entre 0 et 100.',
