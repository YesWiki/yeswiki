...
$GLOBALS['translations'] = array_merge(
    ...
    'EDIT_CONFIG_HINT_wakka_name' => 'Titre du YesWiki',
    'EDIT_CONFIG_HINT_root_page' => 'Nom de la page d\'accueil',
    'EDIT_CONFIG_HINT_meta_keywords' => 'Mots clés pour le référencement (séparés par des virgules, par plus de 20-30)',
    ...
    'EDIT_CONFIG_HINT_meta' => 'Définition des balises meta',
    'EDIT_CONFIG_HINT_default_write_acl' => 'Droits d\'écriture par défaut des pages',
    'EDIT_CONFIG_HINT_default_read_acl' => 'Droits de lecture par défaut des pages',
    'EDIT_CONFIG_HINT_use_alerte' => 'Afficher un message surgissant après édition d\'une page avant de quitter la page sans sauvegarder',
    'EDIT_CONFIG_HINT_baz_map_center_lat' => 'Choisir la latitude du centre par défaut des cartes du wiki',
    'EDIT_CONFIG_HINT_baz_map_center_lon' => 'Choisir la longitude du centre par défaut des cartes du wiki',
