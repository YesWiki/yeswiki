...
$GLOBALS['translations'] = array_merge(
    ...
    // EDIT_WAKKA_CONFIG_ACTION
    'EDIT_WAKKA_CONFIG_TITLE' => 'Modification du fichier de configuration (wakka.config.php)',
    'EDIT_WAKKA_CONFIG_EXEMPLE' => 'Exemple',
    'EDIT_WAKKA_CONFIG_SAVE' => 'Configuration sauvegardée',
    'EDIT_WAKKA_CONFIG_HINT_wakka_name' => 'Titre du YesWiki',
    'EDIT_WAKKA_CONFIG_HINT_root_page' => 'Nom de la page d\'accueil',
    'EDIT_WAKKA_CONFIG_HINT_meta_keywords' => 'Mots clés pour le référencement (séparés par des virgules, par plus de 20-30)',
    'EDIT_WAKKA_CONFIG_HINT_meta_description' => 'Description du site en une phrase, pour le référencement (Attention : ne pas mettre de "." (point))',
    'EDIT_WAKKA_CONFIG_HINT_meta' => 'Définition des balises meta',
    'EDIT_WAKKA_CONFIG_HINT_default_write_acl' => 'Droits d\'écriture par défaut des pages',
    'EDIT_WAKKA_CONFIG_HINT_default_read_acl' => 'Droits de lecture par défaut des pages',
    'EDIT_WAKKA_CONFIG_HINT_use_alerte' => 'Afficher un message surgissant après édition d\'une page avant de quitter la page sans sauvegarder',
    'EDIT_WAKKA_CONFIG_HINT_baz_map_center_lat' => 'Choisir la latitude du centre par défaut des cartes du wiki',
    'EDIT_WAKKA_CONFIG_HINT_baz_map_center_lon' => 'Choisir la longitude du centre par défaut des cartes du wiki',
    'EDIT_WAKKA_CONFIG_HINT_baz_map_zoom' => 'Choisir le niveau de zoom par défaut des cartes du wiki',
    'EDIT_WAKKA_CONFIG_HINT_baz_map_height' => 'Choisir la hauteur par défaut des cartes du wiki',
    'EDIT_WAKKA_CONFIG_HINT_debug' => 'Activer le mode de debug (\'yes\'/\'no\')',
    'EDIT_WAKKA_CONFIG_HINT_default_language' => '(\'fr\',\'en\',...)',
    'EDIT_WAKKA_CONFIG_HINT_contact_from' => 'Adresse e-mail utilisée pour comme expéditeur des messages depuis les fiches',
    'EDIT_WAKKA_CONFIG_HINT_BAZ_ADRESSE_MAIL_ADMIN' => 'Adresse e-mail de l\'adminstrateur pour comme expéditeur certains messages depuis les fiches',
