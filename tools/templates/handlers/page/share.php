...
$html  = "<div class=\"page\">"."\n";
$html .= "<h2>Envoyer par mail</h2><a class=\"link-mail\" rel=\"#overlay-link\" href=\"".$this->href("mail")."\" title=\"Envoyer le contenu de cette page par mail.\">Envoyer le contenu de cette page par mail</a>\n";
$html .= "<h2>Widget : int&eacute;grer le contenu de cette page ailleurs</h2>"."\n";
$html .= '<div class="info_box">Copier-collez le code ci-dessous dans n\'importe quelle page HTML pour int&eacute;grer le contenu de cette page.</div>'."\n";
