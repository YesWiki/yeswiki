...
if (!$bootstrapjs) {
    $yeswiki_javascripts .= '    <script defer src="tools/templates/libs/vendor/bootstrap.min.js"></script>' . "\n";
}
...
if (!$yeswikijs) {
    $yeswiki_javascripts .= '    <script defer src="tools/templates/libs/yeswiki-base.js"></script>' . "\n";
}
