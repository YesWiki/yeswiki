...
return [
    ...
    'ERROR_MOVING_TEMPORARY_FILE' => 'Error en el moment del desplaçament del fitxer temporal',
    'ERROR_NO_FILE_UPLOADED' => 'Cap fitxer no ha estat descarregat.',
    'ATTACH_TRASH' => 'Cistella',
    'ATTACH_NO_ATTACHED_FILES' => 'fitxers lligats a la pàgina {tag} ara per ara.',
    'ATTACH_DATE_OF_MODIFICATION' => 'Data de modificació',
    'ATTACH_REAL_FILENAME' => 'Nom real del fitxer: {fila}',
    ...
    'ATTACH_HANDLER_AJAXUPLOAD_FOLDER_NOT_READABLE' => 'El dossier de descàrrega no és accessible en escriptura.',
    'ATTACH_HANDLER_AJAXUPLOAD_FILE_TOO_LARGE' => 'El fitxer és massa ample.',
    'ATTACH_HANDLER_AJAXUPLOAD_ERROR' => 'Impossible de salvar el fitxer. El upload ha estat anul·lat o el servidor ha plantat...',
    'ATTACH_HANDLER_AJAXUPLOAD_AUTHORIZED_EXT' => 'El fitxer no té una extensió autoritzada, heus aquí les autoritzades: {ext}.',
    ...
    'EDIT_CONFIG_HINT_ATTACH-VIDEO-CONFIG[DEFAULT_PEERTUBE_INSTANCE]' => 'Adreça del servidor peertube per defecte',
    ...
    'ERROR_MAX_FILE_SIZE' => 'El fitxer descarregat excêde la talla de MAX_PASSA_SIZE, que ha estat especificada en el formulari HTML.',
    'ERROR_PARTIAL_UPLOAD' => 'El fitxer només ha estat parcialment descarregat.',
    ...
    'ATTACH_FILE_MANAGEMENT_TITLE' => 'Gestió dels fitxers lligats a la pàgina {tag}',
