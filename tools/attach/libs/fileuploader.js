...
;(function ( $, window, undefined ) {
    ...
    Plugin.prototype.init = function () {
        ...
        var filedownloadtext = UploadModal.find('.file-option .attach_alt');
        ...
        UploadModal.find('.btn-insert-upload').on('click', function (e) {
            var formvals = UploadModalForm.find('input[name="filename"],:input:not(:hidden)').serialize();
            
            var actionattach = '{{attach file="'+getParameterByName(formvals,'filename')+'" desc="'+getParameterByName(formvals,'attach_alt')+'"';
