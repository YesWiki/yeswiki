...
* abonnement.php
*
* Description : action permettant l'envoi par mail d'une demande d'inscription à une newsletter
*
*@package contact
//Auteur original :
...
if (empty($mail)) {die('<div class="error_box">Action abonnement : param&ecirc;tre mail obligatoire.</div>');}
echo '<div class="formulairemail">
<div class="note"></div>
<form id="ajax-abonne-form" action="'.$this->href('mail').'">
	<label class="grid_2 label-right">Votre adresse mail</label>
	<input class="grid_2 textbox" type="text" name="email" value="" />
	<input class="grid_2 button" type="submit" name="submitnewsletter" value="S\'abonner" />
