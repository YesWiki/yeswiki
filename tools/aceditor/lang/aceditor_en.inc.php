...
$GLOBALS['translations'] = array_merge($GLOBALS['translations'], array(
    ...
    'ACEDITOR_LINK'		        => 'Create a link / Create a page',
    ...
    'ACEDITOR_LINK_OPEN_IN_CURRENT_TAB' => 'Link opens in current tab (old syntax)',
    'ACEDITOR_LINK_OPEN_IN_CURRENT_TAB_ACTION_SYNTAX'=> 'Link opens in current tab',
