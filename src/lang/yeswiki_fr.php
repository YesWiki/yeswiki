...
qui rend 1 si bf_type == premiere_cle sinon 0).',
 ...
 - les opérations sont insensibles à la casse',
    ...
    'HEALTH_RETIRED_CHROME_OVERRIDES_SAYS' => 'La barre de titre, le menu haut et le menu rapide sont désormais une configuration commune à tout le wiki. Ces pages portent l\'habillage du wiki ; la bannière, le menu latéral et le pied de page restent redéfinissables page par page.',
