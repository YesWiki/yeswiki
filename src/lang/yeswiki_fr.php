...
return [
    ...
    'PRESENTATION_MAP' => 'Carte',
    'PRESENTATION_CALENDAR' => 'Calendrier',
    'PRESENTATION_MAP_AND_TABLE' => 'Carte et tableau',
    'PRESENTATION_CUSTOM' => 'personnalisé',
    'SORT_LABEL' => 'Trier',
    'SORT_DEFAULT' => 'Trier',
    'SORT_RELEVANCE' => 'Pertinence',
    'SORT_TITLE_ASC' => 'Titre A → Z',
    'SORT_TITLE_DESC' => 'Titre Z → A',
    'SORT_UPDATED_DESC' => 'Modifié récemment',
    'SORT_UPDATED_ASC' => 'Modifié anciennement',
    'SORT_CREATED_DESC' => 'Créé récemment',
    'SORT_CREATED_ASC' => 'Créé anciennement',
    ...
    'SEARCH_TYPE_LIST' => 'Liste',
    'SEARCH_NARROW_TO_FORM' => 'Restreindre à un formulaire',
    ...
    'CREATION_OF_JOURNAL' => 'Création du Journal',
    ...
    'ACL_PICKER_GROUP' => 'Groupe %{name}',
    'ACL_PICKER_OTHER' => 'Noms d\'utilisateur·ices, séparés par des virgules',
    'ACL_PICKER_ONLY' => 'Seulement…',
    'ACL_PICKER_ADVANCED_HINT' => 'Une règle par ligne : * tout le monde, + connecté·es, % propriétaire, @groupe, NomUtilisateur ; un ! devant interdit.',
    ...
    'TEMPLATE_EDIT_THIS_ENTRY' => 'Éditer la fiche',
    'TEMPLATE_EDIT_THIS_ACCOUNT' => 'Éditer le compte',
    'TEMPLATE_EDIT_THIS_FILE' => 'Éditer le fichier',
    'TEMPLATE_EDIT_THIS_FORM' => 'Éditer le formulaire',
    'TEMPLATE_EDIT_THIS_LIST' => 'Éditer la liste',
...
{{end elem="col"}}',
    ...
    'AB_templates_nav_menu_hint' => 'Un des menus de ce wiki. Modifiez-le dans Apparence > Menus ; toutes les pages qui l\'affichent suivent.',
    'AB_templates_nav_showicons_label' => 'Afficher les icônes',
    'AB_templates_nav_showlabels_label' => 'Afficher les libellés',
    'AB_templates_nav_showdropdown_label' => 'Ouvrir les sous-menus en déroulant',

    'MENU_ADD_ENTRY' => 'Ajouter une entrée',
    'MENU_ENTRY_LABEL' => 'Libellé',
    'MENU_ENTRY_LINK' => 'Page, url ou ancre',
    'MENU_ENTRY_ICON' => 'Icône',
    'MENU_ENTRY_ICON_SOURCE' => 'Origine de l\'icône',
    'MENU_ENTRY_ICON_SPRITE' => 'Symbole',
    'MENU_ENTRY_ICON_EMOJI' => 'Émoji',
    'MENU_ENTRY_ICON_FILE' => 'Fichier',
    'MENU_ENTRY_ICON_CHOOSE' => 'Choisir un fichier',
    'MENU_ENTRY_DRAG' => 'Glisser pour réordonner',
    'MENU_ENTRY_INDENT' => 'Placer sous l\'entrée au-dessus',
    'MENU_ENTRY_OUTDENT' => 'Remonter au premier niveau',
    'MENU_ENTRY_UP' => 'Monter',
    'MENU_ENTRY_DOWN' => 'Descendre',
    'MENU_ENTRY_REMOVE' => 'Supprimer cette entrée',
    'MENU_FLAGS' => 'Comment cet emplacement l\'affiche',
    'MENU_FLAG_SHOWICONS' => 'Icônes',
    'MENU_FLAG_SHOWLABELS' => 'Libellés',
    'MENU_FLAG_SHOWDROPDOWN' => 'Menus déroulants',
    'LIST_VALUE_COLOR' => 'Couleur de cette valeur',
    'DASHBOARD_LISTS' => 'Listes de valeurs',
    'DASHBOARD_LISTS_INTRO' => 'Les vocabulaires dans lesquels les formulaires de ce wiki puisent.',
    'ADMIN_LISTS_INTRO' => 'Une liste de valeurs est le vocabulaire des formulaires : les choix qu\'un champ propose, et la couleur et l\'icône que chaque valeur porte partout où elle est affichée.',
    'ADMIN_LISTS_IMPORTED' => 'Listes copiées d\'un autre wiki',
    'ADMIN_LISTS_IMPORTED_HINT' => 'Ce sont des listes ordinaires, que vous pouvez modifier. Suivre la source autorise le wiki d\'origine à remplacer vos modifications à la prochaine synchronisation.',
    'ADMIN_LISTS_ORIGIN_BADGE' => 'Importée',
    'ADMIN_LISTS_FOLLOWED_BADGE' => 'Suivie',
    'ADMIN_LISTS_FOLLOW' => 'Suivre la source',
    'ADMIN_LISTS_FOLLOWED' => 'Cette liste suit désormais le wiki dont elle vient.',
    'ADMIN_LISTS_NOT_FOLLOWED' => 'La liste n\'a pas été mise en suivi.',
    'ADMIN_LISTS_NO_ORIGIN' => 'cette liste n\'a été copiée de nulle part',
    'DASHBOARD_ADMIN_MENUS' => 'Menus',
    'ADMIN_MENUS_INTRO' => 'Un menu est du contenu : il est versionné, il porte ses propres droits, et tout ce qui l\'affiche suit quand vous le modifiez. Le menu haut et l\'accès rapide affichent les deux menus désignés sur l\'écran Apparence.',
    'ADMIN_MENUS_TITLE' => 'Titre',
    'ADMIN_MENUS_ENTRIES' => 'Entrées',
    'ADMIN_MENUS_USED_BY' => 'Utilisé par',
    'ADMIN_MENUS_CHROME' => 'Habillage du site',
    'ADMIN_MENUS_CHROME_HINT' => 'Ce menu est affiché par l\'habillage du wiki. Seuls les admins peuvent l\'écrire.',
    'ADMIN_MENUS_NEW' => 'Un nouveau menu',
    'ADMIN_MENUS_NONE' => 'Aucun menu pour l\'instant.',
    'ADMIN_MENUS_SAVED' => 'Menu enregistré.',
    'ADMIN_MENUS_NOT_SAVED' => 'Le menu n\'a pas été enregistré.',
    'LAYOUT_NAVBAR_MENU_TITLE' => 'Navigation principale',
    'LAYOUT_QUICK_MENU_TITLE' => 'Accès rapide',
    ...
    'AB_templates_section_wrappedcontentexample' => "## Titre\n\nTexte de votre section à remplacer par la suite",
...
%{hint}',
    ...
    'BAZ_CHECKCONTENT_FORM_LABEL' => 'Formulaire à vérifier',
    'BAZ_CHECKCONTENT_NO_PROBLEM' => 'Aucun problème trouvé dans les %{entries} fiches de ce formulaire.',
    'BAZ_CHECKCONTENT_SUMMARY' => '%{problems} problèmes trouvés dans %{entries} fiches.',
    'BAZ_CHECKCONTENT_REPAIRED' => '%{count} valeurs réparées dans %{entries} fiches.',
    'BAZ_CHECKCONTENT_REPAIR_FAILED' => 'Certaines fiches n\'ont pas pu être enregistrées :',
    'BAZ_CHECKCONTENT_REPAIR' => 'Réparer la sélection',
    'BAZ_CHECKCONTENT_CONFIRM' => 'Les valeurs sélectionnées vont être supprimées. Chaque fiche garde son historique, une réparation peut donc être annulée depuis les versions de la page. Continuer ?',
    'BAZ_CHECKCONTENT_COLUMN_ENTRY' => 'Fiche',
    'BAZ_CHECKCONTENT_COLUMN_FIELD' => 'Champ',
    'BAZ_CHECKCONTENT_COLUMN_VALUE' => 'Valeur enregistrée',
    'BAZ_CHECKCONTENT_COLUMN_FIX' => 'Réparation',
    'BAZ_CHECKCONTENT_FIX_MANUAL' => 'à corriger à la main',
    ...
    'BAZ_CHECKCONTENT_BROKEN_ENTRY_HINT' => 'La fiche liée n\'existe plus. La réparation supprime le lien mort et garde les autres.',
    'BAZ_CHECKCONTENT_INVALID_EMAIL' => 'Adresse mail mal formée',
    'BAZ_CHECKCONTENT_INVALID_EMAIL_HINT' => 'La réparation enlève les espaces et passe l\'adresse en minuscules ; si elle reste invalide, le champ est vidé.',
    'BAZ_CHECKCONTENT_INVALID_DATE' => 'Date illisible',
    'BAZ_CHECKCONTENT_INVALID_DATE_HINT' => 'La valeur enregistrée ne peut pas être lue comme une date. La réparation vide le champ, car deviner une date reviendrait à inventer une donnée.',
    'BAZ_CHECKCONTENT_INVALID_URL' => 'Adresse web mal formée',
    'BAZ_CHECKCONTENT_INVALID_URL_HINT' => 'La réparation enlève les espaces ; si l\'adresse reste invalide, le champ est vidé.',
    'BAZ_CHECKCONTENT_ORPHAN_FIELD' => 'Champ absent du formulaire',
    'BAZ_CHECKCONTENT_ORPHAN_FIELD_HINT' => 'La fiche enregistre une donnée sous un nom que le formulaire ne définit plus, en général le reste d\'un champ renommé ou supprimé. Lisez la valeur avant de la retirer.',
    'BAZ_CHECKCONTENT_ENTRY_NOT_FOUND' => 'Fiche introuvable',
    'BAZ_CHECKCONTENT_UNREADABLE_ENTRY' => 'Le contenu de la fiche n\'est pas un JSON lisible',
    'BAZ_CHECKCONTENT_COLUMN_TYPE' => 'Type',
    'BAZ_CHECKCONTENT_COLUMN_SOURCE' => 'Origine des valeurs',
    'BAZ_CHECKCONTENT_NO_OPTIONS' => 'Champs sans valeurs de référence',
    'BAZ_CHECKCONTENT_NO_OPTIONS_HINT' => 'La liste visée par ces champs est vide ou supprimée : toutes les valeurs enregistrées paraîtraient fausses. Restaurez la liste, ou pointez le champ vers une liste existante.',
    'BAZ_CHECKCONTENT_FIX_NOTHING' => 'rien à faire',
    'BAZ_CHECKCONTENT_MISSING_FILE' => 'Fichier envoyé disparu du serveur',
    'BAZ_CHECKCONTENT_MISSING_FILE_HINT' => 'La fiche désigne un fichier absent du répertoire d\'envoi. La réparation vide le champ, ce que la fiche montre déjà aux visiteurs. Restaurez d\'abord le fichier depuis une sauvegarde si vous voulez le récupérer.',
    'BAZ_CHECKCONTENT_UNREACHABLE_URL' => 'Fichier externe qui ne répond plus',
    'BAZ_CHECKCONTENT_UNREACHABLE_URL_HINT' => 'Une requête HEAD sur cette adresse a renvoyé un statut d\'erreur, ou a échoué. Une requête par adresse distincte, résultats non conservés. Un serveur peut tomber une heure puis revenir, donc rien n\'est réparé automatiquement ici.',
    'BAZ_CHECKCONTENT_UNFETCHED_URL' => 'Fichier externe laissé de côté',
    'BAZ_CHECKCONTENT_UNFETCHED_URL_HINT' => 'Ces adresses n\'ont pas été interrogées du tout : on ne sait donc rien d\'elles, ni dans un sens ni dans l\'autre.',
...
qui rend 1 si bf_type == premiere_cle sinon 0).',
 ...
 - les opérations sont insensibles à la casse',
    ...
    'FORM_EDIT_PRESENTATION_DEFAULT' => 'Réglage du wiki (%{value})',
    'FORM_EDIT_PRESENTATION_DEFAULT_NONE' => 'Réglage du wiki',
    'FORM_EDIT_ENTRY_TEMPLATE' => 'Gabarit Twig de la fiche',
    'FORM_EDIT_ENTRY_TEMPLATE_HINT' => 'Enregistré dans %{file}. Chaque champ rendu est dans html (html.bf_titre), la fiche brute dans entry. Un gabarit vide est supprimé et la fiche reprend l\'affichage standard.',
    'FORM_EDIT_ENTRY_TEMPLATE_STARTER' => 'Insérer un modèle de départ',
    'FORM_EDIT_ENTRY_TEMPLATE_STARTER_COMMENT' => 'Gabarit de la fiche : chaque champ rendu est disponible dans html',
    'FORM_EDIT_ENTRY_TEMPLATE_INVALID' => 'Le gabarit de la fiche ne compile pas : %{error}',
    'FORM_EDIT_ENTRY_TEMPLATE_NOT_WRITABLE' => 'Le dossier %{path} n\'est pas accessible en écriture : le gabarit ne peut pas être enregistré.',
    ...
    'ADMIN_LAYOUT_INTRO' => 'Ce que ce wiki affiche autour de ses pages : sa marque, son menu, ses boutons d’accès rapide, son bandeau et son pied de page.',
    ...
    'ADMIN_LAYOUT_NAVBAR_HEIGHT' => 'Hauteur',
    'ADMIN_LAYOUT_NAVBAR_HEIGHT_HINT' => 'Celle de la barre du haut, et celle du logo — dont la largeur s’ajuste toute seule. En colonne, seul le logo suit. Ce réglage l’emporte sur ce qu’en dit un préréglage ou une feuille de style.',
    ...
    'ADMIN_LAYOUT_PLACEMENT_HINT' => 'Où se pose le menu principal autour des pages.',
    'ADMIN_LAYOUT_NAVBAR_POSITION' => 'Menu principal',
    'ADMIN_LAYOUT_NAVBAR_POSITION_TOP' => 'Barre horizontale en haut',
    'ADMIN_LAYOUT_NAVBAR_POSITION_LEFT' => 'Colonne à gauche',
    'ADMIN_LAYOUT_NAVBAR_POSITION_RIGHT' => 'Colonne à droite',
    'ADMIN_LAYOUT_HEADER_POSITION' => 'Bandeau',
    'ADMIN_LAYOUT_HEADER_POSITION_AFTER' => 'Après le menu',
    'ADMIN_LAYOUT_HEADER_POSITION_BEFORE' => 'Avant le menu (pleine largeur, le menu commence dessous)',
    'ADMIN_LAYOUT_PAGE_HINT_PAGEHEADER' => 'Le bandeau affiché en haut de chaque page. C’est du contenu wiki : aplat de couleur, image, titre, ce que vous voulez.',
    'ADMIN_LAYOUT_PAGE_HINT_PAGEFOOTER' => 'Le pied de page affiché en bas de chaque page.',
    ...
    'BAZ_FORM_LAST_ENTRY' => 'dernière mise à jour le %{date}',
    ...
    'FORM_SCREEN_BACK_TO_LIST' => 'Retour à la liste',
    'FORM_SCREEN_DISPLAY' => 'Afficher en',
    ...
    'DASHBOARD_ACTIVITY_INDEX' => 'Index des pages',
    'DASHBOARD_DATE_FORMAT' => 'd/m/Y à H:i',
    'DASHBOARD_ANONYMOUS' => 'Visiteur non connecté',
    'DASHBOARD_AUTHOR_SYSTEM' => 'le wiki',
    'DASHBOARD_ACTIVITY_NONE' => 'Rien pour le moment.',
    'DASHBOARD_KEYWORDS_NONE' => 'Aucun mot-clé utilisé pour le moment.',
    'DASHBOARD_INDEX_CAPPED' => 'Les %{shown} premières pages sur %{total}.',
    'AB_advanced_action_dashboard_label' => 'Tableau de bord',
    'AB_advanced_action_dashboard_sections_label' => 'Sections à afficher',
    'AB_advanced_action_dashboard_sections_hint' => 'Séparées par des virgules, dans n\'importe quel ordre : stats, forms, lists, activity, keywords, index, sources, export. Vide pour toutes les afficher.',
    'AB_advanced_action_dashboard_max_label' => 'Nombre de lignes par liste d\'activité',
    ...
    'DASHBOARD_ADMIN_HEALTH' => 'Santé',

    'ADMIN_LOGS_INTRO' => 'Un seul flux, deux mémoires : chaque action est conservée %{audit} jours, et chaque erreur %{diagnostic}. Rien n\'est masqué : la partie la plus ancienne n\'est simplement plus là.',
    'ADMIN_LOGS_AT' => 'Quand',
    'ADMIN_LOGS_CHANNEL' => 'Canal',
    'ADMIN_LOGS_LEVEL' => 'Niveau',
    'ADMIN_LOGS_ACTOR' => 'Qui',
    'ADMIN_LOGS_ACTION' => 'Quoi',
    'ADMIN_LOGS_TARGET' => 'Sur',
    'ADMIN_LOGS_DETAIL' => 'Détail',
    'ADMIN_LOGS_REPEAT' => 'Vu %{count} fois, la dernière le %{last}',
    'ADMIN_LOGS_CHANNEL_ALL' => 'Tout',
    'ADMIN_LOGS_CHANNEL_AUDIT' => 'Actions',
    'ADMIN_LOGS_CHANNEL_DIAGNOSTIC' => 'Erreurs',
    'ADMIN_LOGS_LEVEL_ALL' => 'Tous les niveaux',
    'ADMIN_LOGS_ACTOR_PLACEHOLDER' => 'Tout le monde',
    'ADMIN_LOGS_ACTION_PLACEHOLDER' => 'Tout',
    'ADMIN_LOGS_FROM' => 'Du',
    'ADMIN_LOGS_TO' => 'Au',
    'ADMIN_LOGS_FILTER' => 'Filtrer',
    'ADMIN_LOGS_NONE' => 'Rien dans le Journal ne correspond.',
    'ADMIN_LOGS_RANGE' => 'Entrées %{start} à %{end} sur %{total}',

    'JOURNAL_ACTION_CONTENT_CREATE' => 'a créé',
    'JOURNAL_ACTION_CONTENT_UPDATE' => 'a modifié',
    'JOURNAL_ACTION_CONTENT_DELETE' => 'a supprimé',
    'JOURNAL_ACTION_CONTENT_DUPLICATE' => 'a dupliqué',
    'JOURNAL_ACTION_ACL_CHANGE' => 'a changé les droits de',
    'JOURNAL_ACTION_GROUP_CREATE' => 'a créé le groupe',
    'JOURNAL_ACTION_GROUP_UPDATE' => 'a changé les membres du groupe',
    'JOURNAL_ACTION_GROUP_DELETE' => 'a supprimé le groupe',
    'JOURNAL_ACTION_CONFIG_WRITE' => 'a écrit le fichier de configuration',
    'JOURNAL_ACTION_PACKAGE_UPGRADE' => 'a mis à jour',
    'JOURNAL_ACTION_PACKAGE_DELETE' => 'a supprimé',
    'JOURNAL_ACTION_LOGIN_FAILED' => 'n\'a pas réussi à se connecter comme',
    'JOURNAL_ACTION_MIGRATION_APPLIED' => 'a appliqué la migration',
    'JOURNAL_ACTION_LEGACY' => 'depuis les anciennes pages de log',

    'ADMIN_HEALTH_INTRO' => 'Tout ce qui suit est recalculé à chaque ouverture de cet écran. Corrigez quelque chose et cela disparaît : il n\'y a rien à acquitter.',
    'ADMIN_HEALTH_ALL_WELL' => 'Rien à signaler. Toutes les vérifications que ce wiki sait faire sont passées.',
    'ADMIN_HEALTH_BROKEN' => 'Cassé',
    'ADMIN_HEALTH_DEGRADED' => 'Dégradé',
    'ADMIN_HEALTH_FIX' => 'Aller à l\'écran qui corrige cela',
    'ADMIN_HEALTH_BADGE' => '%{count} point(s) à regarder',

    'HEALTH_PHP_VERSION' => 'Version de PHP',
    'HEALTH_PHP_VERSION_SAYS' => 'Demandez un PHP plus récent à votre hébergeur, ou lancez le wiki via le binaire autonome, qui apporte le sien.',
    'HEALTH_PHP_VERSION_FAILED' => 'ce wiki demande PHP %{needed} et tourne sur %{current}',
    'HEALTH_REQUIRED_EXTENSIONS' => 'Extensions PHP nécessaires',
    'HEALTH_REQUIRED_EXTENSIONS_SAYS' => 'Le wiki ne peut pas fonctionner sans elles. Votre hébergeur les installe ; le binaire autonome les embarque déjà.',
    'HEALTH_EXTENSION_MISSING' => 'ext-%{extension} n\'est pas chargée',
    'HEALTH_DATABASE_DRIVER' => 'Pilote de base de données',
    'HEALTH_DATABASE_DRIVER_SAYS' => 'C\'est l\'extension PHP de la base que ce wiki est configuré pour utiliser : ici, elle n\'est pas optionnelle.',
    'HEALTH_OPCACHE' => 'OPcache',
    'HEALTH_EXT_INTL' => 'Recherche insensible aux accents',
    'HEALTH_EXT_IMAP' => 'Import depuis une boîte mail',
    'HEALTH_FREE_SPACE' => 'Espace disque',
    'HEALTH_FREE_SPACE_SAYS' => 'La base, l\'index de recherche, les caches et toute sauvegarde en cours vivent sur ce disque.',
    'HEALTH_FREE_SPACE_FAILED' => 'il reste %{left}, sous les %{floor} que ce wiki veut garder libres',
    'HEALTH_BUCKET' => 'Stockage objet',
    'HEALTH_BUCKET_SAYS' => 'Créez-le avec `./yeswicli storage:sync`, qui crée le bucket manquant avant de copier quoi que ce soit, ou vérifiez les identifiants dans private/.env.',
    'HEALTH_BUCKET_FAILED' => 'le bucket qui contient %{tiers} ne répond pas',
    'HEALTH_CORE_UPDATE' => 'Version de YesWiki',
    'HEALTH_CORE_UPDATE_SAYS' => 'Sauvegardez avant de mettre à jour ; l\'écran de mise à jour propose de le faire.',
    'HEALTH_PACKAGE_UPDATES' => 'Versions des extensions et des thèmes',
    'HEALTH_PACKAGE_UPDATES_SAYS' => 'Elles se mettent à jour une par une depuis l\'écran des mises à jour.',
    'HEALTH_UPDATE_AVAILABLE' => '%{name} %{version} est disponible',
    'HEALTH_RETIRED_SEARCH_ACTIONS' => 'Thèmes appelant une action de recherche retirée',
    'HEALTH_RETIRED_SEARCH_ACTIONS_SAYS' => 'Les fichiers sur le disque sont à vous : remplacez l\'appel par {{search}}, ou par un bouton vers /search.',
    'HEALTH_RENAMED_ACTIONS' => 'Fichiers nommant une action renommée',
    'HEALTH_RENAMED_ACTIONS_SAYS' => 'Voir docs/action-name-renames.json pour ce qu\'est devenu chaque ancien nom.',
    'HEALTH_RETIRED_CHROME_OVERRIDES' => 'Pages qui redéfinissent l\'habillage du wiki',
    ...
    'HEALTH_SEARCH_INDEX' => 'Index de recherche',
    'HEALTH_SEARCH_INDEX_SAYS' => 'La recherche et tous les mots-clés -- le nuage de mots-clés, l\'autocomplétion, {{listpagestag}} -- sont servis par cet index. Construisez-le avec `./yeswicli search:reindex --rebuild`.',
    'HEALTH_SEARCH_INDEX_MISSING' => 'les tables de l\'index n\'existent pas sur ce wiki',
