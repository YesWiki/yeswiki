...
which returns 1 if bf_type == first_loop otherwise 0).',
    ...
    'ADMIN_LAYOUT_INTRO' => 'What this wiki shows around its pages: its brand, its menu and its quick-access buttons. These used to be wiki pages (PageTitre, PageMenuHaut, PageRapideHaut); they are fields now.',
    ...
    'ADMIN_LAYOUT_NAVBAR_HEIGHT' => 'Bar height',
    'ADMIN_LAYOUT_NAVBAR_HEIGHT_HINT' => 'Sets the logo\'s height too; its width follows on its own. This wins over whatever a preset or a stylesheet says.',
    ...
    'LAYOUT_EDIT_HEADER' => 'Edit the banner',
    'LAYOUT_EDIT_MENU' => 'Edit the side menu',
    ...
    'ADMIN_LAYOUT_PAGES' => 'The chrome pages',
    'ADMIN_LAYOUT_PAGES_HINT' => 'These stay wiki pages: they hold whatever content you put in them, which no set of fields could replace.',
    'ADMIN_LAYOUT_PAGE_HEADER' => 'Banner shown on every page',
    'ADMIN_LAYOUT_PAGE_MENU' => 'Side menu',
    'ADMIN_LAYOUT_PAGE_FOOTER' => 'Footer',
    'ADMIN_LAYOUT_PAGE_MISSING' => 'not created yet',
    ...
    'HEALTH_RETIRED_CHROME_OVERRIDES_SAYS' => 'The title bar, top menu and quick menu are wiki-wide configuration now. These pages wear the wiki layout; the banner, side menu and footer can still be overridden per page.',
