...
class RecentchangesAction extends YesWikiAction implements RegisteredAction
{
    ...
    private function emit(): void
    {
        ...
        } elseif ($user = $this->getService(AuthenticationService::class)->getLoggedUser()) {
        ...
        $period = isset($_GET['period']) ? $_GET['period'] : $this->getService(PerformableArguments::class)->get('period');
        $dateMin = '';
        ...
        if ($pages = $this->getService(PageManager::class)->getRecentlyChanged($max, $dateMin)) {
