...
{
    public const THEME_CLASS = 'YesWiki\Core\Entity\PackageTheme';
    public const TOOL_CLASS = 'YesWiki\Core\Entity\PackageTool';
    public const CORE_CLASS = 'YesWiki\Core\Entity\PackageCore';
