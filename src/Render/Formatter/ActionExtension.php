...
/** Adds support for the YesWiki action syntax, e.g. */
...
/**
 * Recognizes a line containing nothing but {{action ...}} as its own block, so it doesn't get wrapped in a <p> the way it would if left to inline parsing.
 */
